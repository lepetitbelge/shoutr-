const COLOURS = ['rgb(255, 151, 1)','rgb(44, 98, 251)', 'rgb(42, 219, 97)', 'rgb(239, 58, 119)', 'rgb(253, 193, 3)', 'rgb(157, 26, 179)', 'rgb(28, 192, 213)'];
const COLOURSLIGHT = ['rgba(255, 151, 1, 0.2)','rgba(44, 98, 251, 0.2)', 'rgba(42, 219, 97, 0.2)', 'rgba(239, 58, 119, 0.2)', 'rgba(253, 193, 3, 0.2)', 'rgba(157, 26, 179, 0.2)', 'rgba(28, 192, 213, 0.2)'];
